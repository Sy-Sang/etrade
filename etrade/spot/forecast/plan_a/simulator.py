...
if __name__ == "__main__":
    ...
    init_kwargs = {
        "aq_constructor": OrdinaryGaussianKernelDistributionConstructor((0, 50), (0.1, 10), (2, 8)),
        "dp_constructor": OrdinaryGaussianKernelDistributionConstructor((0, 10), (0.1, 10), (2, 8)),
        "rp_constructor": OrdinaryGaussianKernelDistributionConstructor((0, 10), (0.1, 10), (2, 8)),
        "aq_range": (0, 50),
        "dp_range": (0, 1e+6),
        "rp_range": (0, 1e+6),
        "n0": 1000,
